...
function BuildTechData()
    ...
    local techData = {
        ...
        { [kTechDataId] = kTechId.ProwlerMenu,            [kTechDataDisplayName] = "UPGRADE_PROWLER",  [kTechDataTooltipInfo] = "UPGRADE_PROWLER_TOOLTIP", },
        ...
        { [kTechDataId] = kTechId.UpgradeProwler,  [kTechDataCostKey] = kUpgradeProwlerResearchCost,  [kTechDataResearchTimeKey] = kUpgradeProwlerResearchTime,   [kTechDataDisplayName] = "UPGRADE_PROWLER", [kTechDataTooltipInfo] = "UPGRADE_PROWLER_TOOLTIP",    [kTechDataMenuPriority] = -1 },
        ...
        { [kTechDataId] = kTechId.Howl,           [kTechDataCategory] = kTechId.Prowler, [kTechDataDisplayName] = "Howl", [kTechDataCostKey] = kHowlResearchCost, [kTechDataResearchTimeKey] = kHowlResearchTime, [kTechDataTooltipInfo] = "Creates clouds of all available Hive evolutions: Enzyme, Mucous Membrane, and Hallucinations" },  
        --{ [kTechDataId] = kTechId.XenocideHowl,           [kTechDataCategory] = kTechId.Prowler, [kTechDataDisplayName] = "Flash", [kTechDataCostKey] = kXenocideResearchCost, [kTechDataResearchTimeKey] = kXenocideResearchTime, [kTechDataTooltipInfo] = "Blind enemies after a short delay." },  
        ...
        { [kTechDataId] = kTechId.Prowler, [kTechDataUpgradeCost] = kProwlerUpgradeCost, [kTechDataMapName] = Prowler.kMapName, [kTechDataGestateName] = Prowler.kMapName,                      [kTechDataGestateTime] = kProwlerGestateTime, [kTechDataDisplayName] = "Prowler",  [kTechDataTooltipInfo] = "Ground support and pack leader. Has a short range acid attack, and can buff nearby allies with Hive evolutions.",        [kTechDataModel] = Prowler.kModelName, [kTechDataCostKey] = kProwlerCost, [kTechDataMaxHealth] = Prowler.kHealth, [kTechDataMaxArmor] = Prowler.kArmor, [kTechDataEngagementDistance] = kPlayerEngagementDistance, [kTechDataMaxExtents] = Vector(Prowler.kXExtents, Prowler.kYExtents, Prowler.kZExtents), [kTechDataPointValue] = kProwlerPointValue},
