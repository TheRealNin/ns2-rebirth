...
kTechId = createTechIdEnum({
    ...
    -- Alien lifeforms
    'Skulk', 'Prowler', 'Gorge', 'Lerk', 'Fade', 'Onos', "AlienCommander", "AllAliens", "Hallucination", "DestroyHallucination",
    ...
    'LifeFormMenu', 'SkulkMenu', 'ProwlerMenu', 'GorgeMenu', 'LerkMenu', 'FadeMenu', 'OnosMenu',

    -- Alien structures
    'Hive', 'HiveHeal', 'CragHive', 'ShadeHive', 'ShiftHive','Harvester', 'Egg', 'Embryo', 'Hydra', 'Cyst', 'Clog', 'GorgeTunnel', 'EvolutionChamber',
    'GorgeEgg','ProwlerEgg', 'LerkEgg', 'FadeEgg', 'OnosEgg',
    ...
    'UpgradeSkulk', 'UpgradeProwler', 'UpgradeGorge', 'UpgradeLerk', 'UpgradeFade', 'UpgradeOnos',
    ...
    'Bite', 'Sneak', 'Parasite', 'Leap', 'Xenocide',
     ...
     -- Prowler abilities (that aren't skulk)
    'Howl', 'XenocideHowl',
