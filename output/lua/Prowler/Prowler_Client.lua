...
local function UpdateCameraTilt(self, deltaTime)
    ...
    self.currentCameraRoll = LerpGeneric(self.currentCameraRoll, self.goalCameraRoll * Prowler.kCameraRollTiltModifier, math.min(1, deltaTime * Prowler.kCameraRollSpeedModifier))
    self.currentViewModelRoll = LerpGeneric(self.currentViewModelRoll, self.goalCameraRoll, math.min(1, deltaTime * Prowler.kViewModelRollSpeedModifier))

end

function Prowler:OnProcessIntermediate(input)
...
function Prowler:OnProcessSpectate(deltaTime)
