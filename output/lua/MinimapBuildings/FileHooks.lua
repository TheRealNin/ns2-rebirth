...
ModLoader.SetupFileHook( "lua/Shell.lua", "lua/MinimapBuildings/Shell.lua" , "post" )
ModLoader.SetupFileHook( "lua/Spur.lua", "lua/MinimapBuildings/Shell.lua" , "post" )
ModLoader.SetupFileHook( "lua/Veil.lua", "lua/MinimapBuildings/Shell.lua" , "post" )