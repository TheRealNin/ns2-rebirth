...
kMarineBrainActions =
{
    ...
    function(bot, brain)
        ...
        if not bot.decidedIfSavingForJetpack then
            ...
            bot.wantsJetpack = math.random() < 0.4
        end
    ...
    function(bot, brain)
        ...
        if not marine:isa("JetpackMarine") and
...
if kCombatVersion then
    ...
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Armor3,      3.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Scan,        4.0 + math.random() ))
