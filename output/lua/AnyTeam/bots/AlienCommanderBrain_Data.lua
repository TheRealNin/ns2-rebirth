...
function CreateAlienComSenses()
    ...
    s:Add("hives", function(db)
            return GetEntitiesForTeam("Hive", db.bot:GetTeamNumber())
            end)

    s:Add("cysts", function(db)
            return GetEntitiesForTeam("Cyst", db.bot:GetTeamNumber())
            end)

    s:Add("drifters", function(db)
        return GetEntitiesForTeam("Drifter", db.bot:GetTeamNumber())
    end)
