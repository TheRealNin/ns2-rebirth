...
Script.Load("lua/AnyTeam/PrecursorTechMap.lua")
...
local kTechMaps =
{
    ...
    [kPrecursorTeamType] = kPrecursorTechMap
}
local kLines =
{
    [kMarineTeamType] = kMarineLines,
    [kAlienTeamType] = kAlienLines,
    [kPrecursorTeamType] = kMarineLines
}
local kLineColors =
{
...
local kTechMapIconColors =
{
    ...
    [kPrecursorTeamType] = { [kTechStatus.Available] = Color(0.77, 0.16, 0.62, 0.5), [kTechStatus.Allowed] = kAllowedColor,  [kTechStatus.NotAvailable] = kGrey }
