...
local kGhoststructureEnemyMaterial = PrecacheAsset("cinematics/vfx_materials/ghoststructure_enemy.material") 
            ...
            if self:GetIsGhostStructure() then
                ...
                if not self.ghostStructureMaterial then
                    if Client.GetLocalPlayer() and GetAreFriends(self, Client.GetLocalPlayer()) 
                        ...
                        self.ghostStructureMaterial = AddMaterial(model, kGhoststructureEnemyMaterial)
                    end
                end
