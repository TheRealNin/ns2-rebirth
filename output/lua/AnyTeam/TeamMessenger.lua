...
kTeamMessageTypes = enum({ 'GameStarted', 'PowerLost', 'PowerRestored', 'Eject', 'CannotSpawn',
                           ...
                           'GameStartingSoon', 'GameStartAborted'})
...
kTeamMessages[kTeamMessageTypes.GameStartingSoon] = { text = { [kMarineTeamType] = function() return "Game starting in 5 seconds" end,
                                                               [kAlienTeamType] = function() return "Game starting in 5 seconds" end } }
                                                               
kTeamMessages[kTeamMessageTypes.GameStartAborted] = { text = { [kMarineTeamType] = function() return "Game start cancelled" end,
                                                               [kAlienTeamType] = function() return "Game start cancelled" end } }
