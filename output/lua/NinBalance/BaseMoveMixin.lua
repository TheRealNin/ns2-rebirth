...
BaseMoveMixin.kMinimumVelocity = 1/128
...
function BaseMoveMixin:OnProcessMove(input)
    ...
    self.velocityLengthSmoothed = math.min(self.velocityLength, self.velocityLengthSmoothed + kSmoothRate * input.time)
