...
function BuildTechData()
    ...
    table.insert(techData, { [kTechDataId] = kTechId.ShieldGeneratorTech2,           [kTechDataCostKey] = kShieldGenerator2ResearchCost,         [kTechDataResearchTimeKey] = kAdvancedShieldGeneratorTechResearchTime, [kTechDataDisplayName] = "Shield Generator #2", [kTechDataTooltipInfo] =  "Improves shield generator armor bonus to +20 and speeds up regeneration."})
    table.insert(techData, { [kTechDataId] = kTechId.ShieldGeneratorTech3,           [kTechDataCostKey] = kShieldGenerator3ResearchCost,         [kTechDataResearchTimeKey] = kAdvancedShieldGeneratorTechResearchTime, [kTechDataDisplayName] = "Shield Generator #3", [kTechDataTooltipInfo] =  "Improves shield generator armor bonus to +30 and speeds up regeneration."})
